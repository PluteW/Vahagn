...
from libs.models.LSTM import network
...
def train_net(params):
    ...
    # Dataloader
    train_dataset = data_loader.Tactile_Vision_dataset(data_path=params['train_data_dir'],num=params["frame"], transform=False)
    train_data_loader = DataLoader(train_dataset, batch_size=params['batch_size'], shuffle=True,
                                   num_workers=params['num_workers'])
    
    # vaild_model
    vaild_dataset = data_loader.Tactile_Vision_dataset(data_path=params['valid_data_dir'],num=params["frame"], transform=False)
    vaild_data_loader = DataLoader(vaild_dataset, batch_size=1, shuffle=True, num_workers=params['num_workers'])
    
    test_dataset = data_loader.Tactile_Vision_dataset(data_path=params['test_data_dir'],num=params["frame"], transform=False)
...
if __name__ == '__main__':
    ...
    params['save_dir'] = f'libs/models/LSTM'
