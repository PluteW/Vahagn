...
from libs.models.Time.TimeAttentionNet import TimeAttentionNet
...
def train_net(params):
    ...
    # Create network
    slip_detection_model = TimeAttentionNet(base_network=params['cnn'], pretrained=params['pretrained'],
                                            frame=params['frame'],
